...
void main() {
  ...
  sw.stop();
  print('Cauchy RS Encode (1MB, k=4, m=2): ${sw.elapsedMilliseconds} ms');

  sw.reset();
  sw.start();
  final recovered = service.decode(block: block, availableShards: block.shards.sublist(0, 4));
  sw.stop();
  print('Cauchy RS Decode (1MB, k=4): ${sw.elapsedMilliseconds} ms');
}
